...
def test_add_new_pet_with_valid_data(name='sobak', animal_type='собакабабака',
                                     age='7', pet_photo='images/sobak.jpg'):
...
def test_successful_delete_self_pet():
    ...
    if len(my_pets['pets']) == 0:
        pf.add_new_pet(auth_key, "kot_enot", "некот", "5", "images/kot_enot.jpg")
        _, my_pets = pf.get_list_of_pets(auth_key, "my_pets")
...
def test_successful_update_self_pet_info(name='valera', animal_type='котокот', age=15):
...
# Test_1
def test_add_new_pet_no_photo_with_valid_data(name='Енот', animal_type='кот',
                                              age='8'):
...
# Test_2
def test_add_pet_photo_valid_data(pet_photo='images/valera.jpg'):
    ...
    if len(my_pets['pets']) == 0:
        pf.add_new_pet_simple (auth_key, "КотКокос", "котофей", "10")
        _, my_pets = pf.get_list_of_pets (auth_key, "my_pets")
...
# Test_3
def test_add_new_pet_simple_invalid_age(name='КокосНеКот',
                                           animal_type='cat',
                                           age='#@%$'):
...
# Test_4
def test_add_new_pet_with_invalid_symbols(name='QWERTY#^', animal_type='$%POIUY',
                                  age='14', pet_photo='images/sobak.jpg'):
...
# Test_5
def test_add_pet_with_empty_value_in_variable_name(name='', animal_type='ПАУК',
                                                   age='13',
...
# Test_9
def test_get_all_pets_with_incorrect_filter(filter='1234567'):
